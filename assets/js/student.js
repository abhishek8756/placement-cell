...
const openStudentDetails = (e) => {
  ...
  fetch(`/employee/students-page/:${studentId}`)
    ...
    .then((student) => {
      ...
      deleteStudent.setAttribute(
        "href",
        `/employee/students-page/delete-student/${student._id}`
      );
    });
...
// // Replace 'username' below with the actual username
// const usernameInitial = document
//   .querySelector(".student-details")
//   .querySelector("h3.student-name").innerText; // Replace this with the user's actual name

// console.log(usernameInitial);
// const user_Initials = getUserInitials(usernameInitial);

// const userImage = document.getElementById("userImage");
// userImage.setAttribute("data-initials", user_Initials);