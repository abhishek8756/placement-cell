...
router.post(
  "/create-session",
  passport.authenticate("local", { failureRedirect: "/authorization" }),
...
router.get(
  "/students-page/delete-student/:studentId",
...
router.post(
  "/interviews-page/createInterview",
  interviewController.createInterview
);
router.get(
  "/interviews-page/:interviewId",
  interviewController.showUpdateDetail
);
router.post(
  "/interviews-page/update-interview/:interviewId",
  interviewController.updateInterview
);
router.get(
  "/interviews-page/delete-interview/:interviewId",
